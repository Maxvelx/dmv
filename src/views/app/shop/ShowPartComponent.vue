                ...
                <div class="thumb">
                  <div class="single_product">
                    <div class="single_item">
                      <div v-if="part.image !== 0" class="thumb"><img class="img-fluid" :src="part.image"
                                                                      alt="partImage"></div>
                      <div v-if="part.image === 0" class="thumb"><img class="img-fluid"
                                                                      src="/images/etc/zaglushkaPart.jpg"
                                                                      alt="partImage"></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="shop_single_product_details p0-414">
              ...
              <ul class="cart_btns instock_area mb30">
                <li v-if="part.qty && part.qty != 0" style="font-size: 16px" class="list-inline-item"><span
                    class="fa fa-check-circle text-thm3 ml10 mr5 fz18"></span> {{ part.qty }}шт. <span
              ...
              <ul class="cart_btns wishlist_compare mb20">
                <li class="list-inline-item">
                  <button @click.prevent="this.$store.dispatch('addToOrder',part)" type="button" class="btn btn-thm">
                    <img class="mr10" src="/images/shop/cart-bag.svg"
              ...
              <div class="col-8 row">
                ...
                <div v-if="part.part_number_oem" class="col-6">{{ part.part_number_oem ? part.part_number_oem : '' }}</div>
              </div>
            </div>
          </div>
        </div>
